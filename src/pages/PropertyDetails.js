      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            <div className="mb-8">
              <img className="rounded-xl" src={house.imageLg} alt="" />
            </div>
          ...
          <div
            className="flex-1 bg-white w-full mb-8 border-gray-300 
          ...
          >
            ...
            <form className="flex flex-col gap-y-4">
              <input
                className="border border-y-gray-300 focus:border-violet-700
              ...
              outline-none resize-none rounded w-full p-4 h-36 text-sm 
              text-gray-400"
                placeholder="Message*"
              ...
              <div className="flex gap-x-2">
                ...
                hover:border-violet-500 hover:text-violet-500 rounded 
